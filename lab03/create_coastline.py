# Александрова Екатерина 305 группа
import os
import shapefile
import json
import csv
...
processed_files = 0
 
# Выполнение итерации по каждому SHP-файлу и преобразование
for shp_file in shp_files:
    processed_files += 1
    print(f"Конвиртируется в файл {processed_files}/{total_files}: {shp_file}")
 
    # Создание пути к файлам для входных и выходных папок
